...
/*
  names1 = [Aaron, Barb, Connie, Dan, Ellen, Frank]
set(0, "Amy") = Aaron
set(4, "Ellen") = Ellen
set(4, "Evan") = Ellen
names1 = [Amy, Barb, Connie, Dan, Evan, Frank]
contains("Amy") = true indexOf("Amy") = 0
contains("Ben") = false indexOf("Ben") = -1
contains("Dan") = true indexOf("Dan") = 3
names2 = [Aaron, Amy, Ben, Claire, Connie, Debby, Eve, Fiona, Frank, Gina]
names1 + names2 = [Aaron, Amy, Barb, Ben, Claire, Connie, Dan, Debby, Evan, Eve, Fiona, Frank, Gina]
[Aaron, Amy, Barb, Ben, Claire, Connie, Dan, Debby, Evan, Eve, Fiona, Frank, Gina]
 */
