...
public class JMCh12Exercises
{
    ...
    {
        char[] scores = {'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's', 's', 's', 's', 's', 's'};
        
        return scores[(int)(Math.random()*scores.length)];  // TODO fix this!!
    }
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount + " is the number of zeroes at the beginning of an array"; 
