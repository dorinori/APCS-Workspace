...
public class RollingDie extends Die
{
    ...
    {
        return xSpeed > SPEED_LIMIT || xSpeed < -SPEED_LIMIT || ySpeed > SPEED_LIMIT || ySpeed < -SPEED_LIMIT;
    }
    ...
    public void avoidCollision( RollingDie other )
    {
        ...
        while ( Math.abs( xCenter - other.xCenter ) < DIE_SIZE && Math.abs( yCenter - other.yCenter ) < DIE_SIZE )
            move();
    }
