...
public class MergeList
{
        ...
        LinkedList<Item> listB )
    {
        ...
        ListIterator<Item> aIterator = listA.listIterator();
        ListIterator<Item> bIterator = listB.listIterator();
        ...
        while (aIterator.hasNext() && bIterator.hasNext()){
            ...
            Item itemA = aIterator.next();
            Item itemB = bIterator.next();
        ...
        while (aIterator.hasNext()){
            mergedList.add( aIterator.next() );
        }
        
        while (bIterator.hasNext()){
            mergedList.add( bIterator.next() );
        }
