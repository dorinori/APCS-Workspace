...
public class JMCh10Exercises
{
     ...
     * @param name
     *            string name
     * @return finalName which is new string
     */
    ...
    // 10-8
    /**
     * negates the string with 0 or 1
     * 
     * @param str
     *            the string
     * @return newString which is the negated string
     */
    ...
    /*
     * public boolean isConstant( String s ) { int length = s.length(); int
     * count = 0; for(int i = 0; i < length -1; i++) { if(s.charAt( i ) ==
     * s.charAt( i + 1 ) ) { count++; }
     * 
     * }
     */
    ...
    /**
     * checks if whole string is the same
     * 
     * @param s
     *            string
     * @return true or false whether whole string is the same
     */
    ...
    public String removeComment( String str )
    {
        ...
        {
            returnString = str.substring( 0, opening )
                + str.substring( end + 2 );
