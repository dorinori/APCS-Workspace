...
public class KnightTourCritter extends KnightCritter
{
    ...
    // algorithm.
    public int[][] accessGrid = { { 2, 3, 4, 4, 4, 4, 3, 2 }, { 3, 4, 6, 6, 6, 6, 4, 3 }, { 4, 6, 8, 8, 8, 8, 6, 4 },
    ...
    {
        ArrayList<Location> posLocs = getPossibleMoves( loc );
        for ( Location posLoc : posLocs )
        {
            accessGrid[posLoc.getRow()][posLoc.getCol()]--;
