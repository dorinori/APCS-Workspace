...
public class Ch25Exercises
{
     ...
     * from this tree.
     * 
     * @param completeTree represents a complete tree with completeTree[0]
    ...
    {
        Object obj = completeTree[0];
        int x = ( (Integer) obj + 1 )/2;
        completeTree[0] = (Integer) obj - x;    
    }
    ...
    {
        int child = numNodes;
        int parent = numNodes / 2;
 
        while ( items[child] > items[parent] )
        {
            child--;
            parent = child / 2;
        }
    ...
    public void reheapDown( Integer[] items, int numNodes )
    {
        ...
        while ( right <= numNodes + 1 && items[left] < items[x]
            && items[right] < items[x] )
        {
     ...
     * 
     * @param q1 PriorityQueue of Message
    ...
    {
        PriorityQueue<Message> m = new PriorityQueue<Message>();
